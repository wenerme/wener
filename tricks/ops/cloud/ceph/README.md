...
* [Why I think Ceph is an improvement over ZFS for homelab use](https://www.reddit.com/r/homelab/comments/7be88s/why_i_think_ceph_is_an_improvement_over_zfs_for/)
* [README.alpine.md](https://github.com/ceph/ceph/blob/master/README.alpine.md)
  * 官方支持构建 APK
  * 只能使用 musl libc malloc
    * musl 不允许替换 malloc
  * 没有 backtrace 支持

https://ceph.com/planet/huge-changes-in-ceph-container/
