    ...
    (function(A) {
        ...
        k || C
            ? 'object' == typeof JSON && JSON
                ? k
                    ? ((k.stringify = JSON.stringify), (k.parse = JSON.parse))
                    : (k = JSON)
                : C && (k = A.JSON = {})
            : (k = A.JSON || (A.JSON = {}));
            ...
            if (!(p = {}.hasOwnProperty))
                p = function(a) {
                    var f = {},
                        c;
                    if (
                        ((f.__proto__ = w), (f.__proto__ = {toString: 1}), f)
                            .toString != m
                    )
                        p = function(a) {
                ...
                k.stringify = function(a, b, c) {
                    ...
                    if (typeof b == 'function' || (typeof b == 'object' && b))
                        if (m.call(b) == '[object Function]') h = b;
                            ...
                            j = {};
                            for (
                                var d = 0, g = b.length, i;
                                d < g;
                                i = b[d++],
                                    (m.call(i) == '[object String]' ||
                                        m.call(i) == '[object Number]') &&
                                        (j[i] = 1)
                            );
                        }
                    if (c)
                        if (m.call(c) == '[object Number]') {
                            ...
                            m.call(c) == '[object String]' &&
                                (e = c.length <= 10 ? c : c.slice(0, 10));
                ...
                var L = String.fromCharCode,
                    ...
                    H = function(a, b, c) {
                        ...
                        if (typeof e == 'object' && e)
                            if (m.call(e) == '[object Array]')
                                for (h = e.length; h--; ) I(e, h, c);
                            else
                                B(e, function(a) {
                                    I(e, a, c);
                                });
