...
'===============================测试
im = loadres( "PT_res.rlb", 9)


showpic( - 1, im, 0, 0, 240, 320, 0, 0, 1)

ScreenPrint_Supper( - 1)
end
'===============
...
asm
call ScreenPrint_Supper_Main:

ScreenPrint_Supper_Main_END:
endasm
...
jpc BE ScreenCapture_Main_Y_Wend_BMP:
