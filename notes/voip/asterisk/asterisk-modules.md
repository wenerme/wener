...
# snmp v3
snmpwalk -v 3 -u asteriskUser -l authPriv -a MD5 -A password DES -X password ASTERISK-MIB::astVersionString < your > -x < your > 127.0.0.1
```
...
https://pkgs.alpinelinux.org/contents?file=*&path=%2Fusr%2Flib%2Fasterisk%2Fmodules&name=&branch=edge&arch=x86_64
...
https://github.com/asterisk/asterisk/blob/master/pbx
...
https://github.com/sipcapture/homer/wiki/Examples%3A-Asterisk
