...
LoadByURL : function( sDataURL, _iLoadLength){ 
	...
	if (window.XMLHttpRequest)// code for IE7+, Firefox, Chrome, Opera, Safari
	  ...
	  var xp =new ActiveXObject("Microsoft.XMLHTTP");
...
WriteLn : function( sSting, _iLoadLength){ return this.Write( sSting + "\n");} ,
...
//多种读取和写入模式
GetInt_BigEndian : function (){ return this.data[ this.offset++] << 24 | this.data[ this.offset++] << 16 |
													 this.data[ this.offset++] << 8 | this.data[ this.offset++];} ,

GetInt_LittleEndian : function (){ return this.data[ this.offset++] | this.data[ this.offset++] << 8 |
													 this.data[ this.offset++] << 16 | this.data[ this.offset++] << 24;} ,
...
GetWord_BigEndian : function(){ return this.data[ this.offset++] << 8 | this.data[ this.offset++];} ,

PutWord_BigEndian : function( wWord){ this.data[ this.offset++] = wWord >> 8 & 0xff00;
												  this.data[ this.offset++] = wWord & 0xff;
												  return this;
												} ,

GetWord_LittleEndian : function(){ return this.data[ this.offset++] | this.data[ this.offset++] << 8;} ,

PutWord_LittleEndian : function( wWord){ this.data[ this.offset++] = wWord & 0xff;
...
GetByte : function(){ return this.data[ this.offset++];} ,
...
PutByte : function( bData){ this.data[ this.offset++] = bData & 0xff; return this;} ,
//返回String ,若无_iLength则等同于toString
Get :function( _iLength){
	var len = this.data.length
	if( typeof( _iLength) != 'undefined')
		len = Math.min( len, _iLength);
...
//同名函数等同于Write
Put : function( sDataString, _iLength){ return this.Write( sDataString, _iLength)} 
